        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
              <asp:GridView  class="grid" ID="gwRegistro" runat="server"
                    AllowPaging="True" AllowSorting="True" OnSelectedIndexChanged="gwRegistro_SelectedIndexChanged" OnPageIndexChanging="gwRegistro_PageIndexChanging" PageSize="12" >
                        <Columns>
